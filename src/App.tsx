...
const initialReportData: ReportData = {
  ...
  forensicSamples: [
    ...
    { step: '2A', material: 'Plucked Pubic hair (mention if shaved)', collected: true, reason: '' },
    { step: '2B', material: 'Cut strands of public hair (mention if shaved)', collected: false, reason: '' },
    { step: '2C', material: 'Cut strands of Matted public hair', collected: false, reason: '' },
    { step: '3A', material: 'Loose foreign pubic hair', collected: false, reason: '' },
    { step: '3B', material: 'Loose fiber of clothing', collected: false, reason: '' },
    { step: '4A', material: 'Two Swabs and two slides from Stains on the body', collected: false, reason: '' },
    { step: '4B', material: 'Two Swabs and two slides for semen', collected: false, reason: '' },
    { step: '4C', material: 'Two Swabs and two slides for blood', collected: false, reason: '' },
    { step: '4D', material: 'Two Swabs from muddy stains, grass etc', collected: false, reason: '' },
    { step: '5A', material: 'One Urethral swabs and two slides (for semen examination and DNA testing)', collected: true, reason: '' },
    { step: '5B', material: 'One Urethral swabs (for STD)', collected: true, reason: '' },
    { step: '5C', material: 'Two Scrotal Swabs and two slides', collected: false, reason: '' },
    { step: '6A', material: 'Two Penile swabs and two slides', collected: false, reason: '' },
    { step: '6B', material: 'Penile washings', collected: false, reason: '' },
    { step: '7 A', material: 'Nail scrapings', collected: false, reason: '' },
    { step: '7 B', material: 'Nail Cuttings', collected: true, reason: '' },
    { step: '8', material: 'Air Dried Saliva Soaked Gauge', collected: true, reason: '' },
    { step: '9A', material: 'Blood for grouping (gauge cloth)', collected: true, reason: '' },
    { step: '9B', material: 'Blood for DNA analysis on DNA card', collected: false, reason: '' }
  ],
  potencyTests: {
    isApplicable: false,
    bloodTests: [],
