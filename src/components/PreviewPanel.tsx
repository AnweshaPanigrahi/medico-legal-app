...
export const PreviewPanel: React.FC<PreviewPanelProps> = ({ data }) => {
  ...
  // Render SVG map inside the document with marked points
          ...
          <div style={{ display: 'flex', justifyContent: 'center', margin: '10px 0', position: 'relative', height: '180px' }}>
            ...
            {marks.map(mark => (
              <div 
                ...
                style={{
                  position: 'absolute',
                  left: `calc(50% - 180px + ${mark.x * 3.6}px)`, // Map percentages back to layout dimensions roughly
                  top: `${mark.y * 1.8}px`,
                  backgroundColor: 'red',
                  color: 'white',
                  borderRadius: '50%',
  ...
  const renderPrintTeethRow = (array: boolean[]) => {
    ...
    // Right side (1 to 8) - index 8 to 15
    ...
    <div className="preview-panel">
      ...
      <div className="report-paper">
        ...
        <div className="report-section">
          ...
          <div className="data-row">
            ...
            <span className="data-label">vide letter. No.</span>
            <span className="data-value">{data.caseParticulars.letterNo}</span>
            <span className="data-label">dated</span>
            <span className="data-value">{data.caseParticulars.letterDate}</span>
          </div>
          <div className="data-row">
        ...
        <div className="report-section">
          ...
          <div className="data-row">
            ...
            <span className="data-label">.S/o</span>
          ...
          <div className="data-row">
            ...
            <span className="data-label">iv. Occupation.</span>
          ...
          {data.accusedParticulars.consentText && (
            <div className="data-row" style={{ marginTop: '5px' }}>
              <span className="data-value" style={{ borderBottom: '1px dotted black', fontSize: '9.5pt', paddingBottom: '3px' }}>
                {data.accusedParticulars.consentText}
              </span>
            </div>
          )}
        ...
        <div className="report-section">
          <div className="data-row">
            <span className="data-label">3. Examined in presence of</span>
      ...
      <div className="report-paper page-break">
        <div className="report-section">
          ...
          <table className="report-table">
            ...
            <tbody>
              <tr>
                <td>Development (Tanner Stage)</td>
                <td>{data.penis.development}</td>
              </tr>
              <tr>
                <td>Any defect</td>
                <td>{data.penis.defect}</td>
              </tr>
              <tr>
                <td>Deformity</td>
                <td>{data.penis.deformity}</td>
              </tr>
              <tr>
                <td>Length and Girth of penis in flaccid condition</td>
                <td>{data.penis.flaccidLengthGirth}</td>
              </tr>
              <tr>
                <td>Length and Girth of penis in erect condition</td>
                <td>{data.penis.erectLengthGirth}</td>
              </tr>
              <tr>
                <td>Glans penis and frenulum</td>
                <td>{data.penis.glansFrenulum}</td>
              </tr>
              <tr>
                <td>Whether foreskin can be freely rolled up or is circumcised</td>
                <td>{data.penis.foreskinRoll}</td>
              </tr>
              <tr>
                <td>Any injury on the frenulum</td>
                <td>{data.penis.frenulumInjury}</td>
              </tr>
              <tr>
                <td>Any injury elsewhere on the organ</td>
                <td>{data.penis.otherInjury}</td>
              </tr>
              <tr>
                <td>Evidence of any disease e.g. STD</td>
                <td>{data.penis.stdEvidence}</td>
              </tr>
              <tr>
                <td>Presence of smegma under the foreskin</td>
                <td>{data.penis.smegma}</td>
              </tr>
              <tr>
                <td>Hair under prepuce</td>
                <td>{data.penis.prepucalHair}</td>
              </tr>
              <tr>
                <td>Any stains nearby</td>
                <td>{data.penis.nearbyStains}</td>
              </tr>
            </tbody>
          </table>
          <div className="data-row">
        ...
        <div className="report-section" style={{ marginTop: '15px' }}>
          ...
          <table className="report-table">
            ...
            <tbody>
              <tr>
                <td>Development (Tanner Stage)</td>
                <td>{data.scrotum.development}</td>
              </tr>
              <tr>
                <td>Enlargement</td>
                <td>{data.scrotum.enlargement}</td>
              </tr>
              <tr>
                <td>Both testes descended or not</td>
                <td>{data.scrotum.testesDescended}</td>
              </tr>
              <tr>
                <td>Any disease</td>
                <td>{data.scrotum.disease}</td>
              </tr>
              <tr>
                <td>Any injury</td>
                <td>{data.scrotum.injury}</td>
              </tr>
              <tr>
                <td>Cremasteric Reflex</td>
                <td>{data.scrotum.cremastericReflex}</td>
              </tr>
            </tbody>
          </table>
          <div className="data-row">
        ...
        <div className="report-section" style={{ marginTop: '15px' }}>
          <span className="data-label" style={{ fontWeight: 'bold' }}>d. Details regarding any Disease/Injury: (Indicate Y, N, DNK, EO)</span>
          <table className="report-table">
            <thead>
              <tr>
                <th style={{ width: '45%' }}>Region</th>
            ...
            <tbody>
              <tr>
                <td>Vas deference</td>
                <td>{data.diseaseInjury.vasDeferens}</td>
              </tr>
              <tr>
                <td>Epididymis</td>
                <td>{data.diseaseInjury.epididymis}</td>
              </tr>
              <tr>
                <td>Prostate</td>
                <td>{data.diseaseInjury.prostate}</td>
              </tr>
              <tr>
                <td>On the genital</td>
                <td>{data.diseaseInjury.onGenital}</td>
              </tr>
              <tr>
                <td>Anywhere on the body</td>
                <td>{data.diseaseInjury.anywhereOnBody}</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="report-paper page-break">
        <div className="report-section">
          ...
          <div style={{ fontSize: '7.5pt', fontStyle: 'italic', margin: '5px 0' }}>
            LEGEND: AB=Abrasion, ER=Erythema, OI=Other Injury, ALS=Alt Light Source, F/H=Fiber/Hair, PE=Petechiae, BI=Bite, FB=Foreign Body, PS=Potential Saliva, BU=Burn, IN=Induration, SHX=Sample per History, DE=Debris, IW=Incised Wound, SI=Suction Injury, DF=Deformity, LA=Laceration, SW=Swelling, DS=Dry Secretion, MS=Moist Secretion, TB=Toluidine Blue, EC=Ecchymosis, OF=Other Foreign Material, TE=Tenderness, V/S=Vegetation/Soil.
          </div>
      ...
      <div className="report-paper page-break">
        ...
        <div className="report-section" style={{ marginTop: '20px' }}>
          ...
          <table className="report-table" style={{ fontSize: '8.5pt', marginTop: '10px' }}>
            <thead>
              <tr>
                <th style={{ width: '8%' }}>Steps</th>
                <th style={{ width: '45%' }}>Evidence Material</th>
                <th style={{ width: '15%' }}>Collected (Y/N)</th>
      ...
      <div className="report-paper page-break">
        ...
        <div className="report-section" style={{ marginTop: '15px' }}>
          ...
          {data.potencyTests.isApplicable ? (
            <div style={{ fontSize: '9.5pt' }}>
              ...
              <div style={{ fontWeight: 'bold', marginTop: '10px' }}>2. Accused referred for special investigation for confirmation of potency:</div>
              <ul style={{ marginLeft: '20px', marginTop: '5px' }}>
            ...
            <div className="potency-warning-block">
        ...
        <div className="report-section" style={{ marginTop: '20px' }}>
          ...
          <div style={{ paddingLeft: '5px', marginTop: '8px', fontSize: '10pt', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <div className="opinion-paragraph">
              ...
              From examination of the physical & mental development & mental status, there was nothing detected to suggest that the accused is not capable of sexual intercourse.
            </div>
            <div className="opinion-paragraph">
        ...
        <div className="signature-block">
          ...
          <div className="signature-right">
            ...
            <div style={{ marginTop: '10px', height: '40px', border: '1px dashed #ccc', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '8pt', color: '#999' }}>
